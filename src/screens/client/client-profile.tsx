        ...
        <View style={styles.menuItemLeft}>
          <View
            style={[
              ...
              {
                backgroundColor:
                  item.iconBg ?? Colors.primaryLight,
              },
            ]}
          >
            <Ionicons
...
export default function ClientProfile({ navigation }: any) {
  ...
  const accountItems = [
    ...
    },
    {
      ...
      onPress: () =>
        Alert.alert('Coming Soon', 'Edit profile is coming soon.'),
    },
    {
      id: 'payment',
      icon: 'card-outline',
  ...
  const preferenceItems = [
    ...
    },
    {
      ...
      onPress: () =>
        Alert.alert('Help', 'Contact us at support@rentalmeet.com'),
    },
    {
      id: 'about',
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* ── Profile card ──────────────────────────────────────────────── */}
        <Animated.View
          style={[styles.profileCard, { opacity: headerFade }]}
        >
          {/* Amber banner */}
        ...
        {/* ── CTA banner ────────────────────────────────────────────────── */}
        <Animated.View
          style={[styles.ctaBanner, { opacity: headerFade }]}
        >
          <View style={{ flex: 1 }}>
            <Ionicons
              name="location"
            ...
            <Text style={styles.ctaBannerSub}>
              Hundreds of premium venues near you
            </Text>
          </View>
          <TouchableOpacity
        ...
        {/* ── Quick actions ─────────────────────────────────────────────── */}
        <Animated.View
          style={[{ opacity: headerFade }, styles.quickSection]}
        >
          ...
          <View style={styles.quickRow}>
            ...
            >
              ...
              <Text style={styles.quickTileSub}>
                View & manage
              </Text>
            </TouchableOpacity>
        ...
        {/* ── Recent Bookings ───────────────────────────────────────────── */}
        <Animated.View
          style={[styles.bookingsCard, { opacity: headerFade }]}
        >
