...
const TYPE_CONFIG: Record<AlertType, {
  ...
  success: { icon: 'checkmark-circle',  iconColor: '#16A34A', iconBg: '#DCFCE7', accentColor: '#16A34A' },
  error:   { icon: 'close-circle',      iconColor: '#DC2626', iconBg: '#FEE2E2', accentColor: '#DC2626' },
  warning: { icon: 'warning',           iconColor: '#D97706', iconBg: '#FEF3C7', accentColor: '#D97706' },
  info:    { icon: 'information-circle',iconColor: '#FF6B35', iconBg: '#FFF0EB', accentColor: '#FF6B35' },
  confirm: { icon: 'help-circle',       iconColor: '#1A1A1A', iconBg: '#F5F4F0', accentColor: '#1A1A1A' },
};

const BUTTON_STYLES: Record<string, object> = {
  primary:   { bg: '#FF6B35', text: '#FFFFFF', border: 'transparent', shadow: '#FF6B35' },
  secondary: { bg: '#1A1A1A', text: '#FFFFFF', border: 'transparent', shadow: '#1A1A1A' },
  danger:    { bg: '#FEE2E2', text: '#DC2626', border: '#FECACA',      shadow: 'transparent' },
  ghost:     { bg: '#F5F4F0', text: '#888888', border: '#EDECE8',      shadow: 'transparent' },
};
